...
interface ImportMeta {
  ...
  readonly env: {
    ...
    readonly SNOWPACK_PUBLIC_ENABLE_FEATURE?: boolean;
    readonly SNOWPACK_PUBLIC_GTAG_ID: string;
    readonly SNOWPACK_PUBLIC_AUTH0_DOMAIN: string;
    readonly SNOWPACK_PUBLIC_AUTH0_CLIENT_ID: string;
    readonly SNOWPACK_PUBLIC_MY_CALLBACK_URL: string;
  };
}
